    ...
    public function create()
    {
        $spladeInstrumentForm = SpladeForm::make()
            ...
            ->fields([
                ...
                Input::make('instrument_name')->label('instrument_name')->placeholder('enter instrument_name')->required(),
                Date::make('date_of_purchase')->label('date_of_purchase')->placeholder('enter date_of_purchase')->required(),
                Input::make('supplier_company_name')->label('supplier_company_name')->required(),
                Date::make('warranty_period')->label('warranty_period')->placeholder('enter warranty_period')->required(),
                Input::make('company_name')->label('company_name')->placeholder('enter company_name')->required(),
                Input::make('engineer_name')->label('engineer_name')->placeholder('enter engineer_name')->required(),
                Email::make('email_id')->label('email_id')->placeholder('enter email_id')->required(),
                Input::make('phone_no')->label('phone_no')->placeholder('enter phone_no')->required(),
                Input::make('company_contact_no')->label('company_contact_no')->placeholder('enter company_contact_no')->required(),
                Input::make('po_invoice_no')->label('po_invoice_no')->placeholder('enter po_invoice_no')->required(),
                File::make('instrument_photo')->label('instrument_photo')->required(),
                Input::make('bought_from_research_project_fund_name')->label('bought_from_research_project_fund_name')->required(),
                File::make('calibration_detail_image')->label('calibration_detail_image')->required(),

                Input::make('calibration_detail')->label('OR  calibration_detail')->placeholder('calibration_detail')->required(),
                ...
                File::make('instrument_training_manual_protocol_image')->label('OR instrument_training_manual_protocol')->required(),

//                Input::make('instrument_training_manual_protocol')->label('instrument_training_manual_protocol')->placeholder('instrument_training_manual_protocol')->required(),
                Input::make('instrument_working_status')->label('instrument_working_status')->placeholder('instrument_working_status')->required(),
                Date::make('instrument_periodical_service_date')->label('instrument_periodical_service_date')->placeholder('instrument_periodical_service_date')->required(),
    ...
    public function edit($labInstrument)
    {
        ...
        ->fill($data)
            ...
            ->fields([
                ...
                Input::make('company_contact_no')->label('company_contact_no')->placeholder('enter company_contact_no')->required(),
                Input::make('po_invoice_no')->label('po_invoice_no')->placeholder('enter po_invoice_no')->required(),
                File::make('instrument_photo')->label('instrument_photo')->required()->filepond(),
                Input::make('bought_from_research_project_fund_name')->label('bought_from_research_project_fund_name')->required(),
                File::make('calibration_detail_image')->label('calibration_detail_image')->required()->filepond(),
                Input::make('calibration_detail')->label('calibration_detail')->placeholder('calibration_detail')->required(),
                File::make('instrument_training_manual_protocol_image')->label('instrument_training_manual_protocol_image')->required()->filepond(),
                Input::make('instrument_training_manual_protocol')->label('instrument_training_manual_protocol')->placeholder('instrument_training_manual_protocol')->required(),
                Input::make('instrument_working_status')->label('instrument_working_status')->placeholder('instrument_working_status')->required(),
                Date::make('instrument_periodical_service_date')->label('instrument_periodical_service_date')->placeholder('instrument_periodical_service_date')->required(),
